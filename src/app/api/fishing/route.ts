        ...
        if (action === 'encyclopedia') {
            const fishData = {
                ...
                "Uncommon": [
                    ...
                    { "name": "Patin", "base_price": 30, "min_weight": 2.0, "max_weight": 8.0, "image_url": "/assets/fish/Ikan_Patin.png", "description": "Ikan berkulit licin tanpa sisik, memiliki kandungan lemak sehat yang tinggi dan tekstur lembut." },
                    { "name": "Bawal Hitam", "base_price": 28, "min_weight": 1.5, "max_weight": 6.0, "image_url": "/assets/fish/Ikan_Bawal_Hitam.png", "description": "Ikan laut dengan tubuh pipih, dikenal sebagai perenang cepat yang sering ditemukan di perairan karang." },
                    { "name": "Bandeng", "base_price": 35, "min_weight": 1.0, "max_weight": 4.0, "image_url": "/assets/fish/Bandeng.png", "description": "Ikan yang tahan air payau, terkenal karena durinya yang banyak namun rasanya sangat gurih." },
                    { "name": "Toman", "base_price": 32, "min_weight": 2.0, "max_weight": 10.0, "image_url": "/assets/fish/Toman.png", "description": "Predator air tawar yang ganas dari keluarga Channa, memiliki kekuatan tarikan yang luar biasa saat dipancing." },
                    { "name": "Belida", "base_price": 40, "min_weight": 1.0, "max_weight": 5.0, "image_url": "/assets/fish/BelidA.png", "description": "Ikan sungai purba dengan bentuk tubuh melengkung, merupakan bahan utama pembuatan kerupuk kemplang." },
                    { "name": "Kelah", "base_price": 50, "min_weight": 1.5, "max_weight": 8.0, "image_url": "/assets/fish/Kelah.png", "description": "Sering disebut sebagai Kelah Merah, ikan buruan para pemancing karena kelincahan dan harganya yang mahal." },
                    { "name": "Selar", "base_price": 20, "min_weight": 0.5, "max_weight": 2.0, "image_url": "/assets/fish/Ikan_Selar.png", "description": "Ikan pelagis kecil yang sering berenang dalam kelompok besar, sumber protein penting bagi nelayan lokal." },
                    ...
                    { "name": "Layur", "base_price": 38, "min_weight": 1.0, "max_weight": 3.0, "image_url": "/assets/fish/Ikan_Layur.png", "description": "Ikan bertubuh panjang pipih seperti pita, tidak memiliki sisik dan memiliki sirip punggung yang panjang." },
                    { "name": "Tongkol", "base_price": 33, "min_weight": 1.0, "max_weight": 4.0, "image_url": "/assets/fish/Tongkol.png", "description": "Ikan perenang cepat dari keluarga tuna, memiliki daging merah yang padat dan sering dikalengkan." },
                    ...
                    { "name": "Betutu", "base_price": 45, "min_weight": 0.5, "max_weight": 2.0, "image_url": "/assets/fish/Betutu.png", "description": "Ikan malas yang sering berdiam diri di dasar air, namun memiliki nilai jual sangat tinggi karena khasiatnya." },
                    { "name": "Gabus", "base_price": 34, "min_weight": 1.0, "max_weight": 4.0, "image_url": "/assets/fish/Gabus.png", "description": "Ikan predator yang kaya akan albumin, sangat baik untuk mempercepat penyembuhan luka pasca operasi." },
                ...
                "Rare": [
                    ...
                    { "name": "Kurisi", "base_price": 65, "min_weight": 0.5, "max_weight": 2.0, "image_url": "/assets/fish/Kurisi.png", "description": "Ikan dasaran berukuran sedang dengan warna merah muda, sering tertangkap di daerah berpasir." },
                    { "name": "Queenfish", "base_price": 90, "min_weight": 2.0, "max_weight": 10.0, "image_url": "/assets/fish/Queenfish.png", "description": "Ikan petarung yang gesit, sering melompat ke permukaan air saat mencoba melepaskan kail." },
                    ...
                    { "name": "White Seabass", "base_price": 115, "min_weight": 5.0, "max_weight": 20.0, "image_url": "/assets/fish/White_Seabass.png", "description": "Ikan predator pesisir yang cukup langka, dikenal karena suara khas yang mereka keluarkan." },
                    ...
                    { "name": "Lampuga", "base_price": 130, "min_weight": 3.0, "max_weight": 15.0, "image_url": "/assets/fish/Lampuga.png", "description": "Dikenal juga sebagai Mahi-mahi, memiliki warna neon yang indah saat baru keluar dari air." },
                    { "name": "Sapu Laut", "base_price": 75, "min_weight": 1.0, "max_weight": 5.0, "image_url": "/assets/fish/sapu_laut.png", "description": "Ikan unik yang sering menempel di dasar atau dinding untuk membersihkan alga." },
                    { "name": "Nila Merah", "base_price": 100, "min_weight": 0.5, "max_weight": 3.0, "image_url": "/assets/fish/Nila_merah.png", "description": "Varietas nila dengan warna merah muda kekuningan yang menarik, lebih estetis dari nila biasa." },
                    { "name": "Ikan Kurau", "base_price": 110, "min_weight": 3.0, "max_weight": 15.0, "image_url": "/assets/fish/Kurau.png", "description": "Ikan pesisir yang memiliki kumis panjang di bawah dagunya untuk mendeteksi mangsa di lumpur." },
                ...
                "Epic": [
                    { "name": "Arowana Merah", "base_price": 2500, "min_weight": 2.0, "max_weight": 7.0, "image_url": "/assets/fish/Arwana_Merah.png", "description": "Karya seni hidup dari Kalimantan, ikan hias paling mahal yang disimbolkan sebagai naga pembawa rejeki." },
                    { "name": "Koi Jumbo", "base_price": 1000, "min_weight": 1.0, "max_weight": 5.0, "image_url": "/assets/fish/koi_jumbo.png", "description": "Lokal pride yang sudah mencapai ukuran raksasa, memiliki pola warna yang unik dan menenangkan." },
                    { "name": "Giant Trevally", "base_price": 800, "min_weight": 5.0, "max_weight": 25.0, "image_url": "/assets/fish/Giant_Trevally.png", "description": "Gladiator laut yang sangat kuat, dikenal mampu menjatuhkan pemancing dengan tarikannya yang brutal." },
                    { "name": "Sturgeon", "base_price": 2500, "min_weight": 10.0, "max_weight": 50.0, "image_url": "/assets/fish/Sturgeon.png", "description": "Ikan purba penghasil kaviar berharga, tidak banyak berubah sejak zaman dinosaurus." },
                    { "name": "Goliath Tigerfish", "base_price": 3500, "min_weight": 5.0, "max_weight": 30.0, "image_url": "/assets/fish/Goliath_Tigerfish.png", "description": "Predator air tawar dengan gigi menyerupai piranha namun dalam ukuran yang jauh lebih besar." },
                    { "name": "Lobster", "base_price": 1500, "min_weight": 0.5, "max_weight": 3.0, "image_url": "/assets/fish/Lobster.png", "description": "Raja krustasea dengan cangkang keras, memiliki rasa daging yang sangat mewah di jamuan makan malam." },
                    { "name": "Nile Perch", "base_price": 2000, "min_weight": 10.0, "max_weight": 60.0, "image_url": "/assets/fish/Nile_Perch.png", "description": "Raksasa dari sungai Nil yang sangat invasif, dapat tumbuh hingga berat ratusan kilogram." },
