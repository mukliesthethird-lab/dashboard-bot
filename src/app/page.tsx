          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up animate-delay-300">
            ...
            {session ? (
              ...
              <button
                ...
                className="group px-8 py-4 rounded-full glass text-white font-bold text-lg transition-all duration-300 hover:bg-white/10 hover:scale-105 hover:shadow-lg hover:shadow-white/10 flex items-center gap-2 border border-white/10 hover:border-white/30"
              >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              target="_blank"
              className="group px-10 py-5 rounded-full glass text-white font-bold text-lg transition-all duration-300 hover:bg-white/10 hover:scale-105 hover:shadow-lg hover:shadow-white/10 flex items-center gap-2 border border-white/10 hover:border-white/30"
            >
