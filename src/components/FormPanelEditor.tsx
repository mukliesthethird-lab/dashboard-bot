...
const BUTTON_STYLES = [
    ...
    { value: 'secondary', label: 'Secondary', color: 'bg-white/10', hover: 'hover:bg-[#6d6f73]' },
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] bg-black/70 backdrop-blur-sm flex items-center justify-center p-0 md:p-4 animate-fade-in">
            <div className="glass-card w-full h-full md:max-w-6xl md:h-[90vh] md:rounded-[8px] shadow-2xl flex flex-col overflow-hidden border-0 md:border border-white/10 animate-scale-in">
                ...
                {/* Top Bar */}
                <div className="bg-[#212226] border-b border-white/10 px-6 py-3 flex justify-between items-center shadow-sm z-10 shrink-0">
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <div className="w-full md:w-1/2 overflow-y-auto custom-scrollbar p-8 space-y-6">
                        ...
                        >
                            <div className="space-y-3">
                                <textarea
                                    className="w-full h-32 p-4 bg-black/20 border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none resize-none text-sm text-gray-200 placeholder-[#4e5058] transition"
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider py-1">Quick insert:</span>
                                    {['{user}', '{server}'].map(v => (
                                        <button
                                            key={v}
                                            onClick={() => updateConfig({ ...config, message_content: config.message_content + v })}
                                            className="px-2 py-1 bg-black/20 text-gray-400 text-[10px] font-mono rounded-[3px] border border-transparent hover:border-[#5865f2] transition"
                                        >
                                            {v}
                                        </button>
                                    ))}
                                ...
                                <div className="flex bg-black/20 border-b border-white/10 overflow-x-auto no-scrollbar">
                                    {(['body', 'author', 'footer', 'images'] as const).map(tab => (
                                        <button
                                            ...
                                            className={`px-4 py-3 text-[11px] font-bold uppercase tracking-wider transition border-b-2 flex-shrink-0 ${activeEmbedTab === tab ? 'text-white border-[#5865f2] bg-[#5865f2]/10' : 'text-gray-400 border-transparent hover:text-gray-200 hover:bg-black/20'}`}
                                        >
                                            {tab}
                                        </button>
                                    ))}
                                ...
                                <div className="p-4 space-y-4">
                                        ...
                                        <>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full mt-1 p-3 bg-black/20 border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-sm text-gray-200 transition"
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full mt-1 p-3 bg-black/20 border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-sm text-gray-200 h-32 resize-none transition"
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex gap-2 mt-1">
                                                        ...
                                                        <input
                                                            value={config.embed_color}
                                                            onChange={(e) => updateConfig({ ...config, embed_color: e.target.value })}
                                                            className="flex-1 p-2 bg-black/20 border border-transparent focus:border-[#5865F2] rounded-[3px] uppercase text-sm text-gray-200 outline-none transition"
                                                        />
                                                    </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full mt-1 p-3 bg-black/20 border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-sm text-gray-200"
                                                    placeholder="Author"
                                                />
                                            </div>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full mt-1 p-3 bg-black/20 border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-xs text-gray-200"
                                                    placeholder="https://..."
                                                />
                                            </div>
                                        </div>
                                    ...
                                    {activeEmbedTab === 'images' && (
                                        <div className="space-y-4">
                                            <div>
                                                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Thumbnail URL</label>
                                                <input
                                                    type="text"
                                                    value={config.embed_thumbnail}
                                                    onChange={(e) => updateConfig({ ...config, embed_thumbnail: e.target.value })}
                                                    className="w-full mt-1 p-3 bg-black/20 border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-xs text-gray-200 transition"
                                                    placeholder="https://..."
                                                />
                                            </div>
                                            <div>
                                                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Image URL (Main)</label>
                                                <input
                                                    type="text"
                        ...
                        >
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-2">Button Label</label>
                                        <input
                                            type="text"
                                            value={config.button_label}
                                            onChange={(e) => updateConfig({ ...config, button_label: e.target.value })}
                                            className="w-full p-3 bg-black/20 border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-sm text-gray-200 transition"
                                            placeholder="Button Label"
                                        />
                                    </div>
                                    <div>
                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-2">Button Emoji</label>
                                        <div className="relative">
                                            <EmojiPicker 
                                                ...
                                                guildId={guildId}
                                                trigger={
                                                    <button className="w-full p-3 bg-black/20 border border-transparent hover:border-[#5865F2] rounded-[3px] flex items-center justify-center text-2xl h-[46px] transition">
                                ...
                                <div>
                                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-3">Button Style</label>
                        ...
                        >
                            <div className="space-y-4">
                                <p className="text-xs text-gray-400">Customize how the bot appears for this specific post.</p>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-2">Bot Name</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-2">Avatar URL</label>
                                        <input
                                            type="text"
                    ...
                    <div className="hidden md:flex flex-1 bg-white/5 items-center justify-center p-8 overflow-y-auto border-l border-white/10">
                        <div className="w-full max-w-[550px] space-y-4">
                            ...
                            <div className="bg-white/5 font-sans text-white text-[15px] leading-[1.375rem]">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {config.message_content && (
                                            <div className="text-gray-200 mb-2 whitespace-pre-wrap">{config.message_content}</div>
                                        )}
                                            ...
                                            <div className="p-4">
                                                ...
                                                <div className="flex gap-4">
                                                    <div className="flex-1 min-w-0 space-y-2">
                                                        ...
                                                        {config.embed_description && <div className="text-sm text-gray-200 whitespace-pre-wrap">{config.embed_description}</div>}
                                                    </div>
                                                ...
                                                {config.embed_image && (
                                                    <div className="mt-4 rounded-[4px] overflow-hidden border border-white/10">
                                                ...
                                                {config.embed_footer_text && (
                                                    <div className="flex items-center gap-2 mt-4">
                                                        ...
                                                        <span className="text-[12px] text-gray-400 font-medium">{config.embed_footer_text}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
