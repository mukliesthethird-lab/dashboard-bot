...
const BUTTON_STYLES = [
    ...
    { value: 'secondary', label: 'Secondary', color: 'bg-[var(--bg-hover)]', hover: 'hover:bg-[#6d6f73]' },
...
export default function FormPanelEditor({
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] bg-black/70 backdrop-blur-sm flex items-center justify-center p-0 md:p-4 animate-fade-in">
            <div className="bg-[var(--bg-primary)] border border-[var(--border)] w-full h-full md:max-w-6xl md:h-[90vh] md:rounded-[8px] shadow-2xl flex flex-col overflow-hidden border-0 md:border animate-scale-in">
                <ToastContainer toast={toast} onClose={hideToast} />

                {/* Top Bar */}
                <div className="bg-[#212226] border-b border-[var(--border)] px-6 py-3 flex justify-between items-center shadow-sm z-10 shrink-0">
                    <div className="flex items-center gap-4">
                        <button onClick={onClose} className="text-2xl text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] transition">✕</button>
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-1 border-l border-[var(--border)] pl-4 ml-2">
                                <button 
                                    ...
                                    className={`p-2 text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] transition ${historyIndex === 0 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-[var(--bg-hover)] rounded-full'}`}
                                    title="Undo"
                                >
                                ...
                                <button 
                                    ...
                                    className={`p-2 text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] transition ${historyIndex === history.length - 1 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-[var(--bg-hover)] rounded-full'}`}
                                    title="Redo"
                                >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex items-center gap-1 border-l border-[var(--border)] pl-4">
                                <label className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-bold text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] transition cursor-pointer hover:bg-[var(--bg-hover)] rounded-[4px]">
                                ...
                                <button 
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-bold text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] transition hover:bg-[var(--bg-hover)] rounded-[4px]"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <div className="w-full md:w-1/2 overflow-y-auto custom-scrollbar p-8 space-y-6">
                        ...
                        >
                            <div className="space-y-3">
                                <textarea
                                    className="w-full h-32 p-4 bg-[var(--bg-tertiary)] border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none resize-none text-sm text-[var(--text-primary)] placeholder-[#4e5058] transition"
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <span className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider py-1">Quick insert:</span>
                                    {['{user}', '{server}'].map(v => (
                                        <button
                                            key={v}
                                            onClick={() => updateConfig({ ...config, message_content: config.message_content + v })}
                                            className="px-2 py-1 bg-[var(--bg-tertiary)] text-[var(--text-secondary)] text-[10px] font-mono rounded-[3px] border border-transparent hover:border-[#5865f2] transition"
                                        >
                                            {v}
                                        </button>
                                    ))}
                                ...
                                <div className="flex bg-[var(--bg-tertiary)] border-b border-[var(--border)] overflow-x-auto no-scrollbar">
                                    {(['body', 'author', 'footer', 'images'] as const).map(tab => (
                                        <button
                                            ...
                                            className={`px-4 py-3 text-[11px] font-bold uppercase tracking-wider transition border-b-2 flex-shrink-0 ${activeEmbedTab === tab ? 'text-white border-[#5865f2] bg-[#5865f2]/10' : 'text-[var(--text-secondary)] border-transparent hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)]'}`}
                                        >
                                            {tab}
                                        </button>
                                    ))}
                                ...
                                <div className="p-4 space-y-4">
                                        ...
                                        <>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full mt-1 p-3 bg-[var(--bg-tertiary)] border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-sm text-[var(--text-primary)] transition"
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full mt-1 p-3 bg-[var(--bg-tertiary)] border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-sm text-[var(--text-primary)] h-32 resize-none transition"
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex gap-2 mt-1">
                                                        ...
                                                        <input
                                                            value={config.embed_color}
                                                            onChange={(e) => updateConfig({ ...config, embed_color: e.target.value })}
                                                            className="flex-1 p-2 bg-[var(--bg-tertiary)] border border-transparent focus:border-[#5865F2] rounded-[3px] uppercase text-sm text-[var(--text-primary)] outline-none transition"
                                                        />
                                                    </div>
                                                    <div className="flex gap-1.5 mt-2">
                                                        {COLOR_PRESETS.map(preset => (
                                                            <button
                                                                ...
                                                                className={`w-5 h-5 rounded-full border border-[var(--border)] transition-transform hover:scale-110 ${config.embed_color === preset.value ? 'ring-2 ring-[#5865F2] ring-offset-2 ring-offset-[#2b2d31]' : ''}`}
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full mt-1 p-3 bg-[var(--bg-tertiary)] border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-sm text-[var(--text-primary)]"
                                                    placeholder="Author"
                                                />
                                            </div>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full mt-1 p-3 bg-[var(--bg-tertiary)] border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-xs text-[var(--text-primary)]"
                                                    placeholder="https://..."
                                                />
                                            </div>
                                        </div>
                                    ...
                                    {activeEmbedTab === 'images' && (
                                        <div className="space-y-4">
                                            <div>
                                                <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Thumbnail URL</label>
                                                <input
                                                    type="text"
                                                    value={config.embed_thumbnail}
                                                    onChange={(e) => updateConfig({ ...config, embed_thumbnail: e.target.value })}
                                                    className="w-full mt-1 p-3 bg-[var(--bg-tertiary)] border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-xs text-[var(--text-primary)] transition"
                                                    placeholder="https://..."
                                                />
                                            </div>
                                            <div>
                                                <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Image URL (Main)</label>
                                                <input
                                                    type="text"
                        ...
                        >
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block mb-2">Button Label</label>
                                        <input
                                            type="text"
                                            value={config.button_label}
                                            onChange={(e) => updateConfig({ ...config, button_label: e.target.value })}
                                            className="w-full p-3 bg-[var(--bg-tertiary)] border border-transparent focus:border-[#5865F2] rounded-[3px] outline-none text-sm text-[var(--text-primary)] transition"
                                            placeholder="Button Label"
                                        />
                                    </div>
                                    <div>
                                        <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block mb-2">Button Emoji</label>
                                        <div className="relative">
                                            <EmojiPicker 
                                                ...
                                                guildId={guildId}
                                                trigger={
                                                    <button className="w-full p-3 bg-[var(--bg-tertiary)] border border-transparent hover:border-[#5865F2] rounded-[3px] flex items-center justify-center text-2xl h-[46px] transition">
                                ...
                                <div>
                                    <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block mb-3">Button Style</label>
                        ...
                        >
                            <div className="space-y-4">
                                <p className="text-xs text-[var(--text-secondary)]">Customize how the bot appears for this specific post.</p>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block mb-2">Bot Name</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block mb-2">Avatar URL</label>
                                        <input
                                            type="text"
                    ...
                    <div className="hidden md:flex flex-1 bg-[var(--bg-primary)]/80 items-center justify-center p-8 overflow-y-auto border-l border-[var(--border)]">
                        <div className="w-full max-w-[550px] space-y-4">
                            ...
                            <div className="bg-[var(--bg-hover)] font-sans text-white text-[15px] leading-[1.375rem]">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {config.message_content && (
                                            <div className="text-[var(--text-primary)] mb-2 whitespace-pre-wrap">{config.message_content}</div>
                                        )}

                                        {/* Embed */}
                                        <div className="glass-card rounded-[4px] border-l-4 overflow-hidden max-w-[520px]" style={{ borderLeftColor: config.embed_color }}>
                                            <div className="p-4">
                                                ...
                                                <div className="flex gap-4">
                                                    <div className="flex-1 min-w-0 space-y-2">
                                                        ...
                                                        {config.embed_description && <div className="text-sm text-[var(--text-primary)] whitespace-pre-wrap">{config.embed_description}</div>}
                                                    </div>
                                                ...
                                                {config.embed_image && (
                                                    <div className="mt-4 rounded-[4px] overflow-hidden border border-[var(--border)]">
                                                ...
                                                {config.embed_footer_text && (
                                                    <div className="flex items-center gap-2 mt-4">
                                                        ...
                                                        <span className="text-[12px] text-[var(--text-secondary)] font-medium">{config.embed_footer_text}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
