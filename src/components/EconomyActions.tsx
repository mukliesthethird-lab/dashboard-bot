        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 mt-4">
                <div className="bg-[#2b2d31] rounded-[8px] p-6 border border-[#1e1f22]">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-sm font-bold text-[#b5bac1] uppercase tracking-wide">Total Players</h3>
                    </div>
                    <div className="text-3xl font-bold text-[#dbdee1]">
                ...
                <div className="bg-[#2b2d31] rounded-[8px] p-6 border border-[#1e1f22]">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-sm font-bold text-[#b5bac1] uppercase tracking-wide">Total Economy</h3>
                    </div>
                    <div className="text-3xl font-bold text-[#dbdee1]">
                ...
                <div className="bg-[#2b2d31] rounded-[8px] p-6 border border-[#1e1f22]">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-sm font-bold text-[#b5bac1] uppercase tracking-wide">Richest Player</h3>
                    </div>
            ...
            <div className="bg-[#2b2d31] rounded-[8px] p-6 mb-4 border border-[#1e1f22]">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    <button
                        ...
                        className="p-4 rounded-[4px] bg-[#1e1f22] hover:bg-[#313338] border border-transparent hover:border-[#5865F2]/50 transition text-center group flex flex-col items-center justify-center gap-2 h-28"
                    >
                        <div className="text-2xl group-hover:scale-110 transition bg-[#2b2d31] w-12 h-12 flex items-center justify-center rounded-full text-[#da373c]">💸</div>
                        <div className="font-semibold text-[#dbdee1] text-sm">Give Money</div>
                    </button>
                    <button
                        onClick={() => setShowResetUser(true)}
                        className="p-4 rounded-[4px] bg-[#1e1f22] hover:bg-[#313338] border border-transparent hover:border-[#da373c]/50 transition text-center group flex flex-col items-center justify-center gap-2 h-28"
                    >
                    ...
                    <button
                        ...
                        className="p-4 rounded-[4px] bg-[#1e1f22] hover:bg-[#313338] border border-transparent hover:border-[#5865F2]/50 transition text-center group flex flex-col items-center justify-center gap-2 h-28 md:col-span-1 col-span-2"
                    >
                        ...
                        <div className="font-semibold text-[#dbdee1] text-sm">Leaderboard</div>
                    </button>
                </div>
            </div>
            ...
            {showGiveMoney && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in" onClick={closeModal}>
                    <div className="bg-[#313338] rounded-[8px] p-8 max-w-md w-full mx-4 shadow-2xl relative" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="text-center mb-6">
                            ...
                            <p className="text-[#b5bac1] mt-1 text-sm">Add money to a user's balance</p>
                        </div>

                        <div className="space-y-4">
                            <div>
                                <label className="block text-[12px] font-bold text-[#b5bac1] uppercase tracking-wide mb-2">Select User</label>
                                {selectedUser ? (
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            autoFocus
                                        />
                                        {searching && <div className="absolute right-3 top-2.5 text-[#dbdee1]">⏳</div>}
                                            ...
                                            <div className="absolute z-10 w-full mt-1 bg-[#2b2d31] rounded-[4px] shadow-xl max-h-60 overflow-y-auto py-1 border border-[#1e1f22]">
                                                {searchResults.map(user => (
                                                    <button
                                                        ...
                                                        className="w-full flex items-center gap-3 p-2 hover:bg-[#313338] transition text-left"
                                                    >
                            ...
                            {selectedUser ? (
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={(e) => setSearchQuery(e.target.value)}
                                        placeholder="Search by User ID (min 3 chars)..."
                                        className="w-full px-3 py-2 bg-[#1e1f22] text-[#dbdee1] placeholder-[#87898c] rounded-[3px] focus:outline-none focus:ring-1 focus:ring-[#da373c]"
                                        autoFocus
                                    />
            ...
            {showLeaderboard && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in" onClick={closeModal}>
                    <div className="bg-[#313338] rounded-[8px] p-6 max-w-lg w-full mx-4 shadow-2xl border border-[#1e1f22] max-h-[85vh] flex flex-col relative" onClick={e => e.stopPropagation()}>
                        <button onClick={closeModal} className="absolute top-4 right-4 text-[#b5bac1] hover:text-[#dbdee1] transition z-10">
                            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
                        </button>
                        <div className="text-center mb-6">
                        ...
                        <div className="flex-1 overflow-y-auto space-y-2 min-h-0 pr-2 custom-scrollbar">
                            {filteredLeaderboard.length > 0 ? (
                                paginatedLeaderboard.map((user, index) => {
                                    ...
                                    return (
                                        <div key={user.user_id} className={`flex items-center gap-3 p-3 rounded-[4px] border ${realIndex === 0 ? 'bg-[#f0b232]/10 border-[#f0b232]/30' : realIndex === 1 ? 'bg-[#b5bac1]/10 border-[#b5bac1]/20' : realIndex === 2 ? 'bg-[#f0b232]/5 border-[#f0b232]/10' : 'bg-[#2b2d31] border-transparent'}`}>
            ...
            <div className="bg-[#2b2d31] rounded-[8px] p-6 border border-[#1e1f22]">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-[#dbdee1] mb-1">Economy System</h3>
                        <p className="text-[#b5bac1] text-sm leading-relaxed max-w-2xl">
